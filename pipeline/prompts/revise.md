Read `talk-context.md` and `slides/deck.md`, then every critique under `{{CRITIQUE}}`: it is a run directory
...
Write `{{RUN_DIR}}/changes.md`: one line per finding, grouped by critic, saying what you changed or why you declined.
